  ...
  zh: {
    ...
    landing: {
      ...
      privacy: {
        ...
        visionTitle: 'ChironMotion Vision',
        visionUpdated: '更新日期：2026/03/17。針對影像辨識與 AI 骨架追蹤的數據流與倫理原則進行詳細說明。',
        visionBullets: [
          '強調影像隱私：裝置端處理即刪，不留底片',
  ...
  en: {
    ...
    landing: {
      ...
      privacy: {
        ...
        visionBadge: 'Vision Legal Info',
        visionTitle: 'ChironMotion Vision',
        visionUpdated: 'Updated: 2026/03/17. Detailed explanation of the data flow and ethical principles behind image recognition and AI skeleton tracking.',
        visionBullets: [
          'Image privacy first: processed on-device and not retained',
          'AI ethics statement clearly separates training advice from medical guidance',
        ],
